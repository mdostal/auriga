    ...
    for (const c of cascades) {
      ...
      try {
        ...
        if (!agent && issueObj.assignee_id) {
          ...
          const existingAgentRt = existingAgentName && cfgImpl.AGENTS[existingAgentName]?.runtime;
          if (existingAgentRt && blockedRuntimes.has(existingAgentRt)) {
            logImpl('cascade_skip', { identifier: c.identifier, reason: 'existing-assignee-runtime-blocked', runtime: existingAgentRt });
            continue;
          }
